...
Head over to the [Eluru Custom Theme wiki](https://github.com/UCF/{{My-Project}}/wiki) for detailed information about this theme, installation instructions, and more.
...
5. Set Eluru Custom Theme as the active theme.
